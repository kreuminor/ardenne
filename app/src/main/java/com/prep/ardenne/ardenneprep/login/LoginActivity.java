...
import com.prep.ardenne.ardenneprep.SplashActivity;
import com.prep.ardenne.ardenneprep.SplashGActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(LoginActivity.this, SplashGActivity.class);

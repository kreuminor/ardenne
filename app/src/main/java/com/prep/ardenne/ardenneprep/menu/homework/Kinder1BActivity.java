...
public class Kinder1BActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Kinder1BActivity.this, HCentreActivity.class);
        ...
        getSupportActionBar().setTitle("Kindergarden 1B");
    ...
    private class AnnounceScrape extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                announce = Jsoup.connect("http://drive.google.com/uc?export=downloads&id=0B1VzuZrVMPLNM1RVMG42a2J3cG8").get();

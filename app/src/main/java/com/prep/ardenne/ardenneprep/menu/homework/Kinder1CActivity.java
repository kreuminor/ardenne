...
public class Kinder1CActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Kinder1CActivity.this, HCentreActivity.class);
        ...
        getSupportActionBar().setTitle("Kindergarden 1C");

...
public class ContactActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileModelArrayList.add(new ProfileModelHome("(876) 926-7047 ", "Main Office", R.drawable.pphone));
        profileModelArrayList.add(new ProfileModelHome("(876) 926-7910 ", "Main Office", R.drawable.pphone));
        profileModelArrayList.add(new ProfileModelHome("(876) 920-7865 ", "Bursar Office", R.drawable.pphone));
        profileModelArrayList.add(new ProfileModelHome("Email Us ", "ardenneprep@gmail.com", R.drawable.emaiicon));
    ...
    private class ItemList implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
            ...
            if (i == 0) {
                ...
                Email.putExtra(Intent.EXTRA_TEXT, "Dear Goods Jamaica," + "");  //Email 's Greeting text

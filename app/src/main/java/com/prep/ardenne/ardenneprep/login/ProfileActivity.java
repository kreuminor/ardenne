...
import com.prep.ardenne.ardenneprep.AchieveActivity;
...
public class ProfileActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_announce) {
            ...
            Intent intent = new Intent(ProfileActivity.this, AnnounceActivity.class);
            startActivity(intent);
            overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
            item.setChecked(true);
            finish();
            ...
            Intent intent = new Intent(ProfileActivity.this, CalenderActivity.class);
            startActivity(intent);
            overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
            item.setChecked(true);
            finish();
            ...
            Intent intent = new Intent(ProfileActivity.this, BookActivity.class);
            startActivity(intent);
            overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
            item.setChecked(true);
            finish();
            ...
            Intent intent = new Intent(ProfileActivity.this, ExtraActivity.class);
            startActivity(intent);
            overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
            item.setChecked(true);
            finish();
        ...
        Intent intent = new Intent(ProfileActivity.this, AchieveActivity.class);
        startActivity(intent);
        overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
        item.setChecked(true);
        finish();
            ...
            Intent intent = new Intent(ProfileActivity.this, StaffActivity.class);
            startActivity(intent);
            overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
            item.setChecked(true);
            finish();
